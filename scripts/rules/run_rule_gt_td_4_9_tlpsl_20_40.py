"""Rule-GT-TD-4-9-TLPSL-20-40 is a TD-only 9-indicator agreement rule.
...
RULE_DESCRIPTION = (
    ...
    "TP, SL, or TD opposition logic with a 4-of-9 opposition threshold."
)
SCRIPT_RELATIVE_PATH = "scripts\\rules\\run_rule_gt_td_4_9_tlpsl_20_40.py"
