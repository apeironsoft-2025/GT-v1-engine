...
def test_clean_csv_help_exits_zero() -> None:
    assert _run_cli("clean-csv", "--help").returncode == 0


def test_cleaned_csv_details_help_exits_zero() -> None:
    assert _run_cli("cleaned-csv-details", "--help").returncode == 0
